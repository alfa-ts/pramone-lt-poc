      ...
      <div className="bg-gradient-to-b from-gray-50 to-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-8 pt-8 pb-16">
          ...
          <div className="flex items-center gap-2 text-sm mb-8">
            <a
              href="/apie"
              className="text-gray-500 hover:text-[#FE9A00] transition-colors"
            >
              Apie mus
            </a>
            <ChevronRight className="w-3.5 h-3.5 text-gray-400" />
            <span className="text-gray-700">Istorija</span>
          </div>

          {/* Page Title */}
          <h1 className="text-[40px] leading-tight text-[#101828] mb-6 font-bold">
            Istorija
          </h1>
          ...
          {/* Accent Line */}
          <div className="w-16 h-1 bg-gradient-to-r from-[#FE9A00] to-[#E17100] mt-8 rounded-full"></div>
        </div>
      </div>
